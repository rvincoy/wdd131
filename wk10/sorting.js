...
const hikes = [
 ...
 const simpleList = ["oranges", "grapes", "lemons", "apples", "Bananas", "watermelons", "coconuts", "broccoli", "mango"];
    ...
    console.log('simpleList result: ' + simpleList);
    const simpleSort = simpleList.sort();
    console.log('simpleSort result: ' + simpleSort);
    
    const anotherSort = simpleList.sort(compareFn);
    console.log('anotherSort result: ' + anotherSort);
    
    const lcSort = simpleList.sort(compareFn2);
    console.log('lcSort result: ' + lcSort);
